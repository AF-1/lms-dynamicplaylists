-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_GENRES_NEVERPLAYED
...
create temporary table dynamicplaylist_random_genres as
	select genre_track.genre as genre, sum(ifnull(tracks_persistent.playCount,0)) as sumplaycount from genre_track
