-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_GENRES_TOPRATEDAVG
...
create temporary table dynamicplaylist_random_genres as
	select topavgrated.genre as genre from
		(select genre_track.genre as genre, avg(ifnull(tracks_persistent.rating,0)) as avgrating from genre_track
