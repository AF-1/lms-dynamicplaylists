-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_GENRES_LEASTPLAYEDAVG
...
create temporary table dynamicplaylist_random_genres as
	select leastavgplayed.genre as genre from
		(select genre_track.genre as genre, avg(ifnull(tracks_persistent.playCount,0)) as avgcount from genre_track
