-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_YEARS_LEASTPLAYED
...
create temporary table dynamicplaylist_random_years as
	select leastplayed.year as year from
		(select tracks.year as year, sum(ifnull(tracks_persistent.playCount,0)) as sumcount from tracks
