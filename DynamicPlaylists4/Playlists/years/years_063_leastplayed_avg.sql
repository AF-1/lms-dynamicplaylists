-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_YEARS_LEASTPLAYEDAVG
...
create temporary table dynamicplaylist_random_years as
	select leastavgplayed.year as year from
		(select tracks.year as year, avg(ifnull(tracks_persistent.playCount,0)) as avgcount from tracks
