-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_PLAYLISTS_NEVERPLAYED
...
create temporary table dynamicplaylist_random_playlists as
	select playlist_track.playlist as playlist, sum(ifnull(tracks_persistent.playCount,0)) as sumplaycount from playlist_track
		join tracks on
