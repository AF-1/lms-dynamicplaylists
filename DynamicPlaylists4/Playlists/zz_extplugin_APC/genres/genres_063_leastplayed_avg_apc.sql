-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_GENRES_LEASTPLAYEDAVG_APC
...
create temporary table dynamicplaylist_random_genres as
	select leastavgplayed.genre as genre from
		(select genre_track.genre as genre, avg(ifnull(alternativeplaycount.playCount,0)) as avgcount from genre_track
