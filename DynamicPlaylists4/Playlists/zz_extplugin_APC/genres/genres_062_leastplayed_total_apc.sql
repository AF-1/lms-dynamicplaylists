-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_GENRES_LEASTPLAYED_APC
...
create temporary table dynamicplaylist_random_genres as
	select leastplayed.genre as genre from
		(select genre_track.genre as genre, sum(t.playcount) as sumcount from genre_track
		join (
