-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_YEARS_LEASTPLAYEDAVG_APC
...
create temporary table dynamicplaylist_random_years as
	select leastavgplayed.year as year from
		(select tracks.year as year, avg(ifnull(alternativeplaycount.playCount,0)) as avgcount from tracks
