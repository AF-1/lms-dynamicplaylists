-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS4_BUILTIN_PLAYLIST_WORKS_MOSTRATEDSONGS
...
create temporary table dynamicplaylist_random_works as
	select mostratedtracks.album as album, mostratedtracks.work as work, mostratedtracks.performance as performance from
