-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS3_BUILTIN_PLAYLIST_PLAYLISTS_LEASTPLAYEDAVG
...
create temporary table dynamicplaylist_random_playlists as
	select leastavgplayed.playlist as playlist from
		(select playlist_track.playlist as playlist, avg(ifnull(tracks_persistent.playCount,0)) as avgcount from playlist_track
		join tracks on
