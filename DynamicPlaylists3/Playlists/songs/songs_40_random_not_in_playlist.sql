-- PlaylistName:PLUGIN_DYNAMICPLAYLISTS3_BUILTIN_PLAYLIST_SONGS_RANDOM_IGNORE_SELECTEDPL
-- PlaylistGroups:Songs
-- PlaylistCategory:songs
-- PlaylistParameter1:playlist:PLUGIN_DYNAMICPLAYLISTS3_PARAMNAME_SELECTPLAYLIST_IGNORE:
...
select distinct tracks.url from tracks
	...
	where
		...
		and not exists (select * from tracks t3,playlist_track
						where
